    ...
    return (
        <section className="pt-20 pb-10">
            <div className="container mx-auto">
                ...
                <div className="mt-[60px] flex justify-center">
                    {TABS.map((tab, index) => (
                        <button
                            ...
                            className={`relative pb-5 text-xl 2xl:text-[21px] leading-8 px-[46px] transition ${activeTab === index ? "text-[#5D9732]" : "text-[#404040]"
                                }`}
                        >
                            {tab}
                            {activeTab === index && (
                ...
                {/* Tab Content */}
                <div className="rounded-[20px] border border-[#F6F6F6] p-10">
...
function MelbourneTab() {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            ...
            {/* CONTENT */}
            <div>
                <h3 className="text-2xl 2xl:text-[27px] font-bold leading-8 flex items-center gap-2.5">
                ...
                <div className="flex flex-wrap gap-5">
                    <a href="tel:1800010110">
                        <Button variant="primary" className="2xl:py-[22px]">
                            1800 010 110
                        </Button>
                    </a>
                    <a
                        ...
                        target="_blank"
                    >
                        <Button variant="secondary" className="2xl:py-[23px]">
                            GET DIRECTIONS
                        </Button>
                    </a>
                </div>
